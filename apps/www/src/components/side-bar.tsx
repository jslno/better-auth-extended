		...
		<div className={cn("fixed start-0 top-0")}>
			...
			>
				<div>
					...
					<button
						className="cursor-text flex w-full items-center gap-2 px-5 py-2.5 border-b text-muted-foreground dark:bg-background/75 dark:border-t-border dark:border-t"
						onClick={() => {
							setOpenSearch(true);
						}}
					>
															...
															<Suspense fallback={<>Loading...</>}>
																{listItem.group ? (
																	...
																	<AsideLink
																		...
																		className={cn(
																			"break-words text-nowrap w-[--fd-sidebar-width] [&>div>div]:hover:!bg-fd-muted",
																			listItem.isDisabled &&
...
function SidebarTab({
	...
	return (
		...
		>
			<SelectTrigger className="bg-surface hover:bg-surface/75 h-16 w-full border border-b border-none rounded-none px-5">
				{selected ? (
